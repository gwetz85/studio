  ...
  return (
    <>
      ...
      <Dialog open={isAboutOpen} onOpenChange={setIsAboutOpen}>
        <DialogContent className="max-w-md p-0 overflow-hidden rounded-2xl border-none shadow-2xl max-h-[95vh] flex flex-col">
          <DialogHeader className="bg-primary p-6 text-white text-center shrink-0">
          ...
          <ScrollArea className="flex-1 overflow-y-auto">
            <div className="p-6 space-y-6">
              ...
              <Button onClick={() => setIsAboutOpen(false)} className="w-full h-11 text-xs font-bold shadow-lg mt-4 shrink-0">Tutup</Button>
            </div>
          </ScrollArea>
        </DialogContent>
      </Dialog>
