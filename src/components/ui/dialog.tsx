...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 bg-white/10 backdrop-blur-md text-white/70 hover:text-white transition-colors outline-none focus:ring-2 focus:ring-primary ring-offset-2 z-50">
        <X className="h-4 w-4" />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-6 bg-slate-50/50 dark:bg-slate-900/50 border-t",
      className
    )}
    {...props}
  />
